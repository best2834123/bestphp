...
<div class="super_container">
	...
	<?php
		...
		if(isset($_POST['username'])) {
			...
			echo "<div class='form login'  align='center'>
			<form action='' method='post' name='login'>
				<h3>Username</h3>
				<input type='text1' name='username' placeholder='Username' required>
				<h3>Password</h3>
				...
				<div class="col-lg-4 footer_col">
					<div class="footer_menu">
						...
						<ul class="footer_list">
							<li>
								<a href="https://www.facebook.com/palmchonrudee-110135363786820/"><div>Customer Service<div class="footer_tag_1">online now</div></div></a>
							</li>
							<li>
